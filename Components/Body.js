...
const Body = () => {
  return (
    <ThemeProvider attribute="class">
      ...
      >
        <Header />
        <section data-scroll data-scroll-speed="0.3" id='home' className='overflow-hidden min-h-screen px-44 w-screen bg-white dark:bg-[#2E2E2E] max-[1024px]:px-8 max-[320px]:px-4'>
          <Home />
        </section>
        ...
        <section id='project' className='overflow-hidden min-h-screen pb-24 pt-0 px-60 w-screen bg-white dark:bg-[#2E2E2E] max-[1024px]:px-8 md:max-[1024px]:min-h-[70vh] max-[640px]:px-0' >
          <Project />
        </section>
        <Footer />
      </motion.div>

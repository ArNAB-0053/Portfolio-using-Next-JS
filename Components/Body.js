...
const Body = () => {
  return (
    <ThemeProvider attribute="class">
      ...
      >
        <Header />
        <section id='home' className='overflow-hidden min-h-screen px-44 w-screen bg-white dark:bg-[#2E2E2E] max-[1024px]:px-8 max-[320px]:px-4'>
          <Home />
        </section>
        <section id='about' className='overflow-hidden min-h-screen px-48 w-screen bg-[#f0f0f0] dark:bg-[#454545] max-[1024px]:px-8 lg:max-[1280px]:px-8'>
          <About />
        </section>

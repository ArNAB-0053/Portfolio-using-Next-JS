...
function ProjectSlider({
  ...
  useEffect(() => {
    ...
    if (activeTab === "All") {
      ...
      setFilteredProjects(
        projects.filter((project) => project.project_tag.includes("web")),
      );
    } else if (activeTab === "React Native") {
      setFilteredProjects(
        projects.filter((project) => project.project_tag.includes("react-native")),
      );
    } else if (activeTab === "Machine Learning") {
      setFilteredProjects(
        projects.filter((project) => project.project_tag.includes("ml")),
      );
    } else if (activeTab === "Extension") {
      setFilteredProjects(
        projects.filter((project) => project.project_tag.includes("extension")),
      );
    }
    ...
    <div className="">
      ...
      >
        {filteredProjects.map((project, index) => (
          <SwiperSlide className="swiperSlider" key={`${project.id}-${index}`}>
            <Projectcontainer
              id={project.id}

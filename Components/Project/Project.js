    ...
    <div className="mt-16 mb-[-2rem] sm:mb-0 w-full">
      ...
      <div className="relative">
        <div className="overflow-hidden">
          ...
          >
            My projects consist of a diverse range, including React Native, web, and machine learning projects.Some of them were developed for hackathons, Some of them were developed for
            hackathons, where I worked alongside my teammates to turn ideas into reality.

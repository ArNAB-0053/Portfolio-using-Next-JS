...
const Projectcontainer = ({project_heading, project_desc, project_img, link, bg = 'transparent'}) => {
    return (
        <div       
        className='project_content_div flex flex-col gap-4 w-64 h-auto bg-[#F0F0F0] rounded-xl pb-3 dark:bg-[#454545] dark:shadow-own-shadow max-[640px]:shadow-none max-[640px]:dark:shadow-none max-[640px]:rounded'>
            <Image

...
const socialLinks = [
  {
    id: "link1",
    href: "https://www.facebook.com/arnab.bhattacharyya.520",
    icon: (
      <svg
        id="linkIcon"
  ...
  {
    id: "link2",
    href: "https://www.instagram.com/__arnab_bhattacharyya/",
    icon: (
      <svg
        id="linkIcon"
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    id: "link3",
    href: "https://www.linkedin.com/in/arnab-bhattacharyya-380966291/",
    icon: (
      <svg
        id="linkIcon"
        className="text-black"
  ...
  {
    id: "link4",
    href: "https://twitter.com/__Ar_nab__",
    icon: (
      <svg
        id="linkIcon"
        className="text-black"
...
// Animation wrapper component that conditionally applies animations
const AnimatedSection = ({ isMobile, initialProps, children }) => {
  if (isMobile) {
    return <div className={initialProps.className}>{children}</div>;
  }

  return (
    <motion.div
      initial={initialProps.initial}
      transition={initialProps.transition}
      whileInView={initialProps.whileInView}
      ...
      >
        <AnimatedSection isMobile={isMobile} initialProps={contactAnimProps}>
          <h1 className="conatct_heading text-white my-4 flex items-center justify-center gap-4 ">
            <p className="text-5xl uppercase font-black max-[500px]:text-3xl">
              Contact{" "}
            </p>
            <p className="font-[DancingScriptMedium] text-5xl font-thin">Me</p>
          </h1>

          <ContactForm />
        </AnimatedSection>

        <AnimatedSection isMobile={isMobile} initialProps={connectAnimProps}>
          <h1 className=" px-6 py-4 text-center">
            <h2 className="connect_text text-xl uppercase font-black text-black">
              Connect{" "}
            </h2>
            <p className="withme_text text-2xl mt-[-0.8rem] text-black">
              with me
            </p>
          </h1>

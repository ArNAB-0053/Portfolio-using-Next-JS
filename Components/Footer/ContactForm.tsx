...
interface ContactTemplateParams extends Record<string, string> {
  first_name: string;
  last_name: string;
  email: string;
  subject: string;
...
const ContactForm = (): JSX.Element => {
  ...
  const [website, setWebsite] = useState<string>(""); // Honeypot state

  const [isSubmitting, setIsSubmitting] = useState<boolean>(false);
  const [showFallbackModal, setShowFallbackModal] = useState<boolean>(false); // Modal fallback state
